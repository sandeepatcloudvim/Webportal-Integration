report 50003 "DAX Standard Sales Order Conf"
{
    RDLCLayout = './StandardSalesOrderConf_DANA.rdlc';
    WordLayout = './StandardSalesOrderConf_DANA.docx';
    Caption = 'DA Sales - Confirmation';
    DefaultLayout = Word;
    ...
    dataset
    {
        ...
        "Sales Header")
        {
            ...
            column(SellToFaxNo;
            "Sell-to Phone No.") //  GetSellToCustomerFaxNo)
            {
            }
            ...
            column(ExtDocNo_SalesHeader;
            "External Document No.")
            {
            }
            column(ExtDocNo_SalesHeader_Lbl;
            ...
            "Sales Line")
            {
                ...
                column(CrossReferenceNo;
                "Cross-Reference No.")
                {
                }
                column(CrossReferenceNo_Lbl;
                FieldCaption("Cross-Reference No."))
                {
                }
                column(UnitPrice_Lbl2;
                UnitPriceLbl)
                {
                }
                column(LineAmount_Lbl;
                LineAmountLbl)
                {
                }
            ...
            dataitem(USReportTotalsLine;
            "Report Totals Buffer")
            {
                DataItemTableView = SORTING("Line No.");
                UseTemporary = true;

                column(Description_USReportTotalsLine;
                Description)
                {
                }
                column(Amount_USReportTotalsLine;
                Amount)
                {
                }
                column(AmountFormatted_USReportTotalsLine;
                "Amount Formatted")
                {
                }
                column(FontBold_USReportTotalsLine;
                "Font Bold")
                {
                }
                column(FontUnderline_USReportTotalsLine;
                "Font Underline")
                {
                }
                trigger OnPreDataItem()
            ...
            "Integer")
            {
                ...
                // column(AmountSubjectToSalesTax;
                // VATAmountLine.GetAmtSubjectToSalesTax)
                // {
                // }
                column(AmountSubjectToSalesTaxLbl;
                AmtSubjecttoSalesTaxLbl)
                {
                }
                // column(AmountExemptFromSalesTax;
                // VATAmountLine.GetAmtExemptFromSalesTax)
                // {
                // }
                column(AmountExemptFromSalesTaxLbl;
